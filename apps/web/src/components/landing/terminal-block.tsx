  ...
  return (
    <div className="w-full max-w-xl overflow-hidden rounded-lg border border-border bg-card shadow-2xl">
      ...
      <div className="flex h-[320px]">
        {/* Sidebar */}
        <div className="w-40 border-r border-border bg-muted/20 p-3">
          <button
            type="button"
            className="mb-3 flex w-full items-center gap-1.5 rounded-md border border-dashed border-border px-2 py-1.5 text-[10px] text-muted-foreground transition-colors hover:border-accent-orange hover:text-accent-orange"
          >
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 rounded-md bg-accent-orange/10 px-2 py-1.5">
            ...
            <div className="flex items-center gap-2 rounded-md px-2 py-1.5 transition-colors hover:bg-muted/50">
              <OpenAIIcon className="size-3.5 text-[#10A37F]" />
          ...
          <div className="mt-4 border-t border-border pt-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
                <OpenAIIcon className="size-3 text-[#10A37F]" />
                Codex CLI
              </div>
              <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
        ...
        <div className="flex-1 overflow-hidden p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="rounded bg-accent-orange/20 px-1.5 py-0.5 text-[9px] text-accent-orange">
              Claude Code
            </span>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-accent-orange/30 bg-accent-orange/5 p-3">
              <div className="mb-1 flex items-center gap-1.5">
                <ClaudeIcon className="size-3" />
                <p className="text-[9px] font-medium text-accent-orange">
                  Claude
                </p>
              </div>
              <p className="font-mono text-[11px] text-foreground/80">
                I'll help you refactor the auth module. Let me analyze the
                current implementation...
              </p>
              <div className="mt-2 flex items-center gap-1.5">
                <span className="size-1.5 animate-pulse rounded-full bg-accent-orange" />
